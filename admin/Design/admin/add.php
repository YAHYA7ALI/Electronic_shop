                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="admin" action="database/add-admin.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="file" name="img" class="form-control form-control-admin" placeholder="Image">
                                </div>
                                <div class="form-group">
