<?php
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
			<?php
					$select = "SELECT * FROM `products` ORDER BY id  LIMIT 3 " ;
					$reslet = $conn -> query($select);
					while ($row = $reslet -> fetch_assoc()) {
				?>
				<div class="item-slick1 item1-slick1" style="background-image: url(admin/img/<?= $row['img'] ?>);">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="admin/img/<?= $row['img'] ?>" alt="IMG-PRODUCT">
